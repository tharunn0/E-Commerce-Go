...
func (repo *CategoryRepository) UpdateCategory(ctx context.Context, category *domain.Category) (*domain.Category, error) {
	query := `
...
func (repo *CategoryRepository) ChangeCategoryStatus(ctx context.Context, id int64, isActive bool) (*domain.Category, error) {
...
func (repo *CategoryRepository) GetCategoryByID(ctx context.Context, id int64, activeOnly bool) (*domain.Category, error) {
...
func (repo *CategoryRepository) GetAllCategories(ctx context.Context, activeOnly bool) ([]*domain.Category, error) {
